  ...
  if (!localStorage.getItem("memberid")) {
    ...
    .then((response) => {
      if (response.items[0].status == 1) {
        ...
        <a href="https://m.youtube.com/@thaalammediaofficial" target="_blank"><button class="custom-btn btn-11">Meet and Greet<div class="dot"></div></button></a>
        ...
        <a href="index"><img src="./img/audio.svg"> Audio</a>
        <a href="https://m.youtube.com/@thaalammediaofficial" target="_blank"><img src="./img/tv.svg"> TV</a>
        <a href="https://drive.google.com/drive/folders/17W6wxFbVf71Q9VYPrUaj6W5msHnr8ck5?usp=sharing" target="_blank"><button class="custom-btn btn-11">Meet and Greet<div class="dot"></div></button></a>
...
function SetLogin1() {
  ...
  if (!localStorage.getItem("memberid")) {
    ...
    <div class="upgradeSubscription"><a href="signup" style="color:#fff;" class="header_sunscription_button__shqYE btn btn-primary">Subscribe</a></div>&nbsp;&nbsp;&nbsp;&nbsp;    
...
if (!localStorage.getItem("memberid")) { 
   ...
   <a href="https://drive.google.com/drive/folders/17W6wxFbVf71Q9VYPrUaj6W5msHnr8ck5?usp=sharing" target="_blank"> <button class="custom-btn btn-11">Meet and Greet<div class="dot"></div></button></a>
    <a class="header__action-btn" href="signin">
      <img src="./img/signin.svg" style="width:35px;"/>
    </a>
   `;
  } else { 
    document.getElementById(
    ...
    <img src="./img/profile.svg" style="width:35px;"/>
  </a>
   `;
  }
  if (localStorage.getItem("memberid")) {
    ...
    <a href="contact" class="sidebar__nav-link mobilelogout1">
...
let ele4=document.getElementById(
  "commonnavbar4"
);
if(ele4){
  if (!localStorage.getItem("memberid")) {
...
function getBlogs(){
  const id = '';
  fetch('./mobileApi/blogs.php',{body : JSON.stringify({id}),method : "POST"}).then((res)=>res.json()).then((response)=>{
    console.log(response);
    let str = "";
    for (let x of response.items) {
      ...
      <div class="post">
        ...
        <div class="post__content">
          <h3 class="post__title"><a href="single_blog?id=${x.id}">${x.title}</a></h3>
...
function getRecentBlogs(){
  const id = '';
  fetch('./mobileApi/recent_blogs.php',{body : JSON.stringify({id}),method : "POST"}).then((res)=>res.json()).then((response)=>{
    console.log(response);
    let str = "";
    for (let x of response.items) {
      str += `<div class="col-12 col-sm-6 col-lg-4">
